...
Register Declarations for ST10F269 Processor
...
---------------------------------------------------------------------------*/
#ifndef __REGST10F269_H__
#define __REGST10F269_H__
...
/* SYSCON2 and SYSCON3 (only in some devices) */
sfr   SYSCON2  = 0xF1D0;
sbit  RCS      = SYSCON2^6;
sbit  SCS      = SYSCON2^7;
