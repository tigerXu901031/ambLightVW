...
#if (SCS_F_PLL_TARGET < 1000000) || (SCS_F_PLL_TARGET > 66000000)
...
//*****************************************************************************
// @Function      Scs_ErrorType Scs_lApplyNewVcoDivs
//                (unsigned int PDiv, unsigned int NDiv, unsigned int K2Div)
//
//-----------------------------------------------------------------------------
