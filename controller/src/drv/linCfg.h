...
*/
#define LIN_CFG_CHANNEL_ID       (USIC_U0C0_CHANNEL)
...
#define LIN_PORT_OUT                          PORT_2
#define LIN_PIN_IN                            PIN_4
#define LIN_PIN_OUT                           PIN_3
...
*/
#define _IFC_NAD                              2  /*Value in one byte*/
...
*/
#define _IFC_RESP_ERR_FRM_NUM                 0
