 ...
 *
 * \defgroup IfxLld_Demo_VadcBackgroundScanDemo_InterruptConfig Interrupt configuration
 * \ingroup IfxLld_Demo_VadcBackgroundScanDemo
 */
...
/**
 * \addtogroup IfxLld_Demo_VadcBackgroundScanDemo_InterruptConfig
 * \{ */
