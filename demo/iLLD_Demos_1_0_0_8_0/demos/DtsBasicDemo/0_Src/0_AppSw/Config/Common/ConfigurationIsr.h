 ...
 *
 * \defgroup IfxLld_Demo_DtsBasicDemo_SrcDoc_InterruptConfig Interrupt configuration
...
/**
 * \addtogroup IfxLld_Demo_DtsBasicDemo_SrcDoc_InterruptConfig
 * \{ */
