 ...
 *
 * \defgroup IfxLld_Demo_Ccu6Icu_SrcDoc_InterruptConfig Interrupt configuration
...
/**
 * \addtogroup IfxLld_Demo_Ccu6Icu_SrcDoc_InterruptConfig
 * \{ */
...
#define ISR_PRIORITY_CCU6_ICU       4   /**< \brief Define the CCU6 ICU interrupt priority.  */
...
#define ISR_PROVIDER_CCU6_ICU       IfxSrc_Tos_cpu0 /**< \brief Define the CCU6 ICU interrupt provider.  */
...
#define INTERRUPT_CCU6_ICU          ISR_ASSIGN(ISR_PRIORITY_CCU6_ICU, ISR_PROVIDER_CCU6_ICU)             /**< \brief Install the CCU6 ICU interrupt handler.  */
