 ...
 *
 * \defgroup IfxLld_Demo_MulticanGatewayFifo_SrcDoc_InterruptConfig Interrupt configuration
...
/**
 * \addtogroup IfxLld_Demo_MulticanGatewayFifo_SrcDoc_InterruptConfig
 * \{ */
