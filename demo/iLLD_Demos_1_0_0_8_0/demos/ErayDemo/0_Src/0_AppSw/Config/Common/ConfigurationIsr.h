 ...
 *
 * \defgroup IfxLld_Demo_ErayDemo_SrcDoc_InterruptConfig Interrupt configuration
...
/**
 * \addtogroup IfxLld_Demo_ErayDemo_SrcDoc_InterruptConfig
 * \{ */
...
#define ISR_PRIORITY_ERAY_INT0      40 /**< \brief Define the Eray Status and Error 0  interrupt priority.  */
#define ISR_PRIORITY_ERAY_INT1      20 /**< \brief Define the Eray Status and Error 1  interrupt priority.  */
#define ISR_PRIORITY_ERAY_NDAT1     10 /**< \brief Define the Eray New Data  1  interrupt priority.  */
/** \} */
...
#define ISR_PROVIDER_ERAY_INT0      IfxSrc_Tos_cpu0            /**< \brief Define the Eray Status and Error 0 interrupt provider.  */
#define ISR_PROVIDER_ERAY_INT1      IfxSrc_Tos_cpu0            /**< \brief Define the Eray Status and Error 1 interrupt provider.  */
#define ISR_PROVIDER_ERAY_NDAT1     IfxSrc_Tos_cpu0            /**< \brief Define the Eray New Data  1 interrupt provider.  */
/** \} */
...
#define INTERRUPT_ERAY_INT0         ISR_ASSIGN(ISR_PRIORITY_ERAY_INT0, ISR_PROVIDER_ERAY_INT0)                          /**< \brief Define the Eray Status and Error 0 interrupt priority.  */
#define INTERRUPT_ERAY_INT1         ISR_ASSIGN(ISR_PRIORITY_ERAY_INT1, ISR_PROVIDER_ERAY_INT1)                          /**< \brief Define the Eray Status and Error 1 interrupt priority.  */
#define INTERRUPT_ERAY_NDAT1        ISR_ASSIGN(ISR_PRIORITY_ERAY_NDAT1, ISR_PROVIDER_ERAY_NDAT1)                        /**< \brief Define the Eray New Data  1 interrupt priority.  */
/** \} */
