 ...
 *
 * \defgroup IfxLld_Demo_GtmAtomPwmHl_SrcDoc_InterruptConfig Interrupt configuration
 * \ingroup IfxLld_Demo_GtmAtomPwmHl_SrcDoc
 */
...
/**
 * \addtogroup IfxLld_Demo_GtmAtomPwmHl_SrcDoc_InterruptConfig
 * \{ */
