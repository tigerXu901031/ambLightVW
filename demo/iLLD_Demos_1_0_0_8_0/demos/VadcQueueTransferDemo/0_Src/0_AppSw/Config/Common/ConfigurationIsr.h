 ...
 *
 * \defgroup IfxLld_Demo_VadcQueueTransferDemo_SrcDoc_InterruptConfig Interrupt configuration
...
/**
 * \addtogroup IfxLld_Demo_VadcQueueTransferDemo_SrcDoc_InterruptConfig
 * \{ */
