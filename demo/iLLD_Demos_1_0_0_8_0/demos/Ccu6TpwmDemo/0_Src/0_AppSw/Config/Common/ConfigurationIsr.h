 ...
 *
 * \defgroup IfxLld_Demo_Ccu6Tpwm_SrcDoc_InterruptConfig Interrupt configuration
...
/**
 * \addtogroup IfxLld_Demo_Ccu6Tpwm_SrcDoc_InterruptConfig
 * \{ */
...
#define ISR_PRIORITY_CCU6_TPWM      4   /**< \brief Define the CCU6 TPWM interrupt priority.  */
...
#define ISR_PROVIDER_CCU6_TPWM      IfxSrc_Tos_cpu0 /**< \brief Define the CCU6 TPWM interrupt provider.  */
...
#define INTERRUPT_CCU6_TPWM         ISR_ASSIGN(ISR_PRIORITY_CCU6_TPWM, ISR_PROVIDER_CCU6_TPWM)           /**< \brief Install the CCU6 TPWM interrupt handler.  */
