 ...
 *
 * \defgroup IfxLld_Demo_Ccu6Timer_SrcDoc_InterruptConfig Interrupt configuration
...
/**
 * \addtogroup IfxLld_Demo_Ccu6Timer_SrcDoc_InterruptConfig
 * \{ */
...
#define ISR_PRIORITY_CCU6_TIMER     4   /**< \brief Define the CCU6 TIMER interrupt priority.  */
...
#define ISR_PROVIDER_CCU6_TIMER     IfxSrc_Tos_cpu0 /**< \brief Define the CCU6 TIMER interrupt provider.  */
...
#define INTERRUPT_CCU6_TIMER        ISR_ASSIGN(ISR_PRIORITY_CCU6_TIMER, ISR_PROVIDER_CCU6_TIMER)         /**< \brief Install the CCU6 TIMER interrupt handler.  */
