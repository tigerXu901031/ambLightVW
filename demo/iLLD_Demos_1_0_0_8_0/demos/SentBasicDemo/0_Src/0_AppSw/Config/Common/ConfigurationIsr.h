 ...
 *
 * \defgroup IfxLld_Demo_SentBasicDemo_SrcDoc_InterruptConfig Interrupt configuration
...
/**
 * \addtogroup IfxLld_Demo_SentBasicDemo_SrcDoc_InterruptConfig
 * \{ */
...
#define ISR_PRIORITY_SENT_CH0       20 /**< \brief Define the Sent Channel0 interrupt priority.  */
/** \} */
...
#define ISR_PROVIDER_PRINTF_ASC0_EX IfxSrc_Tos_cpu0
#define ISR_PROVIDER_SENT_CH0       IfxSrc_Tos_cpu0       /**< \brief Define the Sent Channel0 interrupt provider.  */
/** \} */
...
#define INTERRUPT_SENT_CH0          ISR_ASSIGN(ISR_PRIORITY_SENT_CH0, ISR_PROVIDER_SENT_CH0)             /**< \brief Define the Sent Channel0 interrupt priority.  */
/** \} */
