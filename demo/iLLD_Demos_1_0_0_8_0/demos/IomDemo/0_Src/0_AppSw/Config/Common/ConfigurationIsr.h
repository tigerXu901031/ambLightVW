 ...
 *
 * \defgroup IfxLld_Demo_IomDemo_SrcDoc_InterruptConfig Interrupt configuration
...
/**
 * \addtogroup IfxLld_Demo_IomDemo_SrcDoc_InterruptConfig
 * \{ */
...
#define ISR_PRIORITY_TIMERREF       (10) /**< \brief Define the Iom Reference signal interrupt priority.  */

#define ISR_PRIORITY_TIMERMON       (30) /**< \brief Define the Iom Monitor signal interrupt priority.  */
/** \} */
...
#define ISR_PROVIDER_GTM_INT0       IfxSrc_Tos_cpu0             /**< \brief Define the Generic Timer Module (GTM) interrupt provider.  */
/** \} */
...
#define INTERRUPT_GTM_INT2          ISR_ASSIGN(ISR_PRIORITY_TIMERREF, ISR_PROVIDER_GTM_INT0)             /**< \brief Define the Iom Reference signal interrupt priority.  */
#define INTERRUPT_GTM_INT4          ISR_ASSIGN(ISR_PRIORITY_TIMERMON, ISR_PROVIDER_GTM_INT0)             /**< \brief Define the Iom Monitor signal interrupt priority.  */
/** \} */
