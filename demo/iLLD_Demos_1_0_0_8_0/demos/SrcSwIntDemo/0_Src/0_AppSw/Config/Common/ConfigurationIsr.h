 ...
 *
 * \defgroup IfxLld_Demo_SrcSwIntDemo_SrcDoc_InterruptConfig Interrupt configuration
...
/**
 * \addtogroup IfxLld_Demo_SrcSwIntDemo_SrcDoc_InterruptConfig
 * \{ */
...
#define ISR_PRIORITY_STM0_SR0       40  /**< \brief Define the System Timer0 interrupt priority.  */
/** \} */
