 ...
 *
 * \defgroup IfxLld_Demo_CpuPerfCounterDemo_SrcDoc_InterruptConfig Interrupt configuration
...
/**
 * \addtogroup IfxLld_Demo_CpuPerfCounterDemo_SrcDoc_InterruptConfig
 * \{ */
