 ...
 *
 * \defgroup IfxLld_Demo_Ccu6PwmBc_SrcDoc_InterruptConfig Interrupt configuration
...
/**
 * \addtogroup IfxLld_Demo_Ccu6PwmBc_SrcDoc_InterruptConfig
 * \{ */
...
#define ISR_PRIORITY_CCU6_PWMBC     4   /**< \brief Define the CCU6 PWMBC interrupt priority.  */
...
#define ISR_PROVIDER_CCU6_PWMBC     IfxSrc_Tos_cpu0 /**< \brief Define the CCU6 PWMBC interrupt provider.  */
...
#define INTERRUPT_CCU6_PWMBC        ISR_ASSIGN(ISR_PRIORITY_CCU6_PWMBC, ISR_PROVIDER_CCU6_PWMBC)         /**< \brief Install the CCU6 PWMBC interrupt handler.  */
